...
Each search form has a <em>target directory</em>. When you run a search, you are redirected to the form's target directory, filtered according to your search.
...
= 5.7.5 =
* Added: *match single* search mode for user groups
= 5.7.4 =
...
= 3.4 06/30/2013 =
* Added the *Value Range Search* option - thanks to Florian Shiessl
= 3.3 05/12/2013 =
