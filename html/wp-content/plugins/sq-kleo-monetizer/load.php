...
class Kleo_Monetizer {
	...
	public function render_before_single_content() {
		if ( ! is_front_page() && ! is_archive() && ! is_home() && is_singular( 'post' ) ) {
			echo '<div class="google-ads pos-1" style="margin: 10px auto;text-align:center;">' . do_shortcode( sq_option( 'km_before_single_content' ) ) . '</div>';
		}
	}
	...
	public function render_after_main_content() {
		if ( ! is_front_page() && ! is_archive() && ! is_home() && is_singular( 'post' ) ) {
			$output = '';
			$output .= '<div class="google-ads pos-2" style="margin: 10px auto;text-align:center;">' . sq_option( 'km_after_single_content' ) . '</div>';
	...
	public function render_before_single_inner_content() {
		if ( ! is_front_page() && is_singular( 'post' ) ) {
			$output = '';
			$output .= '<div class="google-ads pos-3" style="margin: 10px auto;text-align:center;">' . sq_option( 'km_before_single_inner_content' ) . '</div>';
			echo do_shortcode( $output );
		}
	}
	...
	public function render_after_single_inner_main_content() {
		if ( ! is_front_page() && is_singular( 'post' ) ) {
			$output = '';
			$output .= '<div class="google-ads pos-4" style="margin: 10px auto;text-align:center;">' . sq_option( 'km_after_single_inner_main_content' ) . '</div>';
			echo do_shortcode( $output );
		}
	}
	...
	public function render_before_single_archive_content() {
		if ( is_archive() ) {
			$output = '';
			$output .= '<div class="google-ads pos-5" style="margin: 10px auto;text-align:center;">' . sq_option( 'km_before_single_archive_content' ) . '</div>';
			echo do_shortcode( $output );
		}
	}
	...
	public function render_after_single_archive_content() {
		if ( is_archive() ) {
			$output = '';
			$output .= '<div class="google-ads pos-6" style="margin: 10px auto;text-align:center;">' . sq_option( 'km_after_single_archive_content' ) . '</div>';
			echo do_shortcode( $output );
		}
	}
	...
	public function render_before_blog_outer_content() {
		if ( is_home() ) {
			$output = '';
			$output .= '<div class="google-ads pos-7" style="margin: 10px auto;text-align:center;">' . sq_option( 'km_before_blog_outer_content' ) . '</div>';
			echo do_shortcode( $output );
		}
	}
	...
	public function render_after_blog_outer_content() {
		if ( is_home() ) {
			$output = '';
			$output .= '<div class="google-ads pos-8" style="margin: 10px auto;text-align:center;">' . sq_option( 'km_after_blog_outer_content' ) . '</div>';
			echo do_shortcode( $output );
		}
	}
}
